...
public class JpqlRepositoryTest {
    ...
    public void testFindOrders() {
        ...
        for (Object[] objects : list) {
            /*
             * [Member2(id=1, userName=User1, age=1), Product(id=1, name=제품1, price=1000,
             * stockAmount=5), 3]
             */
            ...
            System.out.println(member2); // Member2(id=1, userName=User1, age=1)
            System.out.println(product); // Product(id=1, name=제품1, price=1000, stockAmount=5)
    ...
    public void testFindByAgeList() {
        ...
        List<Member2> list3 = member2Repository.findByTeamIdEqual(2L);
    ...
    public void testJoin() {
        ...
        // Member2(id=2, userName=User2, age=2)
        // Team2(id=2, name=team2)
